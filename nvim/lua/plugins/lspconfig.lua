...
return {
    ...
    config = function()
        ...
        -- Define Tailwind globally, but opt into it per-project from a trusted .nvim.lua:
        --   vim.lsp.enable("tailwindcss")
        -- This keeps the server available without reintroducing the startup freeze
        -- that happened when it was enabled for all non-work repos.
